...
<body>
	...
	<div class="container">
		<form action="./ForumCreateServlet" method="POST">
			<div class="form-input">
				<input type="hidden" value="createSubForum" name="action"></input>
				<input type="hidden" value="${requestScope.parentForumId }" name="parentForumId"></input>
				<label for="name">Naziv</label>
				<input class="form-control" type="text" id="name" name="name" placeholder="Obavezno"/><br/>
				<label for="description">Opis</label>
				<textarea class="form-control" id="description" name="description"></textarea><br/>
				<label for="forumType">Tip foruma</label> 
				<select class="form-control" id="forumType" name="forumType">
					...
					<c:if test="${type == 'Open' }">
			            ...
			            <c:if test="${type == 'Closed' }">
			            <option value="Closed">Zatvoreni</option>
			        </c:if>
				</select></br>
				<a href="./HomepageServlet" class="btn btn-default">Otkazi</a>
